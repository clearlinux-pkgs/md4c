...
Version  : 0.4.6
Release  : 2
URL      : https://github.com/mity/md4c/archive/release-0.4.6/md4c-0.4.6.tar.gz
Source0  : https://github.com/mity/md4c/archive/release-0.4.6/md4c-0.4.6.tar.gz
...
%prep
%setup -q -n md4c-release-0.4.6
cd %{_builddir}/md4c-release-0.4.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1601664301
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/md4c-release-0.4.6/LICENSE.md %{buildroot}/usr/share/package-licenses/md4c/aba96670ff8909af4d895e6e8cfcfa3c42ec43d7
cp %{_builddir}/md4c-release-0.4.6/test/LICENSE %{buildroot}/usr/share/package-licenses/md4c/76cf8e32adfd0d4706a0408a206265bbde15350b
pushd clr-build
%make_install
popd
...
/usr/lib64/libmd4c-html.so.0.4.5
/usr/lib64/libmd4c.so.0
/usr/lib64/libmd4c.so.0.4.5
